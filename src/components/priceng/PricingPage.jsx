        ...
        <div className="w-full min-h-screen py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-slate-50 via-gray-100 to-slate-200 dark:from-zinc-950 dark:via-zinc-900 dark:to-black transition-colors duration-300">
            ...
            <div className="max-w-4xl mx-auto text-center mb-12">
                ...
                <p className="text-base sm:text-lg text-slate-500 dark:text-zinc-400 max-w-xl mx-auto">
                    Choose the perfect plan tailored for your career growth or recruitment cycle.
                </p>
                ...
                <div className="flex justify-center mt-10">
                    <div className="relative flex p-1 bg-slate-200/80 dark:bg-zinc-800/80 backdrop-blur-sm rounded-xl border border-slate-300/30 dark:border-zinc-700/30">
                        ...
                        <div 
                            ...
                            style={{
                                width: 'calc(50% - 4px)',
                                transform: userType === 'seekers' ? 'translateX(0%)' : 'translateX(100%)'
                            }}
                        />
                    </div>
                </div>
                    ...
                    >
                        ...
                        <div>
                            ...
                            <div className="my-6 flex items-baseline text-slate-900 dark:text-zinc-50">
                                ...
                                <span className="text-sm font-semibold text-slate-400 dark:text-zinc-500 ml-1">{plan.period}</span>
                            </div>
            ...
            <div className="max-w-3xl mx-auto border-t border-slate-200 dark:border-zinc-800/80 pt-16">
                ...
                <Accordion 
                    ...
                    itemClasses={{
                        ...
                        trigger: "py-4",
                        content: "text-xs sm:text-sm text-slate-500 dark:text-zinc-400 pb-4 leading-relaxed"
                    }}
                >
                    <AccordionItem key="1" aria-label="Can I switch plans anytime?" title="Can I switch plans anytime?">
                        Yes, absolutely! You can upgrade or downgrade your plan at any point directly from your billing dashboard. If you upgrade, the new features will be unlocked instantly.
                    </AccordionItem>
                    <AccordionItem key="2" aria-label="How do cancellations work?" title="How do cancellations work?">
                        You can cancel your subscription whenever you want. Once cancelled, you will retain access to your premium tier features until the end of your current billing cycle.
                    </AccordionItem>
                    <AccordionItem key="3" aria-label="What payment methods do you accept?" title="What payment methods do you accept?">
                        We support all major international credit/debit cards (Visa, MasterCard, American Express) along with automated local payment gateways depending on your operational location.
                    </AccordionItem>
                    <AccordionItem key="4" aria-label="Do you offer refunds?" title="Do you offer refunds?">
                        Since we offer a fully functional Free Plan to test Heire Loop, we generally do not issue refunds for active subscription months. However, if you experience a technical billing issue, please reach out to support.
                    </AccordionItem>
                </Accordion>
            </div>
